...
;;;###autoload
(defun magit-git-command (cmd directory)
...
repository, otherwise in `default-directory'."
  ...
  (magit-shell-command cmd directory))

;;;###autoload
(defun magit-git-command-topdir (cmd directory)
  "Execute a Git subcommand asynchronously, displaying the output.
...
;;;###autoload
(defun magit-shell-command-topdir (cmd directory)
  "Execute a shell command asynchronously, displaying the output.
